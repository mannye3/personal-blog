                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mt-0 mb-1">Admin Comments</h4>
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <form method="POST" id="adminDeleteComment-{{ $comment->id}}"  action="{{ route('adminDeleteComment', $comment->id)}}">@csrf
                                            <td><button type="button" class="btn btn-danger" onclick="document.getElementById('adminDeleteComment-{{$comment->id}}').submit()" >Delete</button></td>
                                            </form>
