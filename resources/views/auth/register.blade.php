                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input id="email" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="email">
                                                    ...
                                                    @enderror
                                                        ...
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="password" class="form-control" id="password-confirm" required name="password_confirmation" placeholder="Enter password">
                                                        ...
                                                        <div class="mt-4 text-center">
                                                            @if (Route::has('login'))
                                                            <a href="{{ route('login') }}" class="text-muted"><i class="mdi mdi-account-circle mr-1"></i> Already have account?</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
